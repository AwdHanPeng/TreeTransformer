...
class Code2NaturalLanguage(object):
    ...
    def update(self, ex):
        ...
        #here
        code_td_paths_rep = ex['code_td_paths_rep']
        code_local_relations_rep = ex['code_local_relations_rep']
        ...
        if self.use_cuda:
            ...
            #here
            if code_td_paths_rep is not None:
                code_td_paths_rep = code_td_paths_rep.cuda(non_blocking=True)
            if code_local_relations_rep is not None:
                code_local_relations_rep = code_local_relations_rep.cuda(non_blocking=True)
