...
class Embedder(nn.Module):
    def __init__(self, args):
        ...
        #     self.td_tree_pos_encodings = TDTreePositionalEncodings(self.)
...
class Encoder(nn.Module):
    def __init__(self,
        ...
        self.transformer = TransformerEncoder(args, num_layers=args.nlayers,
                                              d_model=input_size,
                                              heads=args.num_head,
                                              d_k=args.d_k,
                                              d_v=args.d_v,
                                              ...
                                              use_td_tree_pos_enc=args.use_td_tree_pos_enc,
                                              inner_TF=args.inner_TF,
                                              use_local_relation=args.local_relation,
                                              )
...
class Decoder(nn.Module):
    def __init__(self, args, input_size):
        ...
        if self.split_decoder:
            ...
            self.transformer_c = TransformerDecoder(args,
            ...
            self.transformer_d = TransformerDecoder(args,
                num_layers=args.nlayers,
                d_model=self.input_size,
                heads=args.num_head,
                d_k=args.d_k,
            ...
            self.transformer = TransformerDecoder(args,
                num_layers=args.nlayers,
                d_model=self.input_size,
                heads=args.num_head,
                d_k=args.d_k,
...
class Transformer(nn.Module):
    ...
    def _run_forward_ml(self,
        ...
        code_rep = self.embedder(code_word_rep,
                                 ...
                                 code_root_paths_rep,
                                 mode='encoder')
        memory_bank, layer_wise_outputs = self.encoder(code_rep, code_len, code_rel_matrix_rep, code_type_rep,
                                                       code_type2_rep, code_word_rep, adj_matrices, code_td_paths_rep,
                                                       code_local_relations_rep)  # B x seq_len x h
    ...
    def forward(self,
        ...
        """
        if self.training: #this is the inherent trigger of pytorch module
    ...
    def decode(self,
        ...
        word_rep = self.embedder(code_word_rep,
                                 ...
                                 code_root_paths_rep,
                                 mode='encoder')
        memory_bank, layer_wise_outputs = self.encoder(word_rep, code_len, code_rel_matrix_rep, code_type_rep,
                                                       code_type2_rep, code_word_rep, adj_matrices, code_td_paths_rep,
                                                       code_local_relations_rep)  # B x seq_len x h
