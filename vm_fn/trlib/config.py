...
def add_model_args(parser):
    ...
    # HERE
    model.add_argument("--use_td_tree_pos_enc", type='bool', default=False, \
                       help="use advance tree positional encodings")
    model.add_argument('--td_max_ary', type=int, default=64,
                       help='maximum width of root path')
    model.add_argument('--td_max_depth', type=int, default=32,
                       help='maximum depth of root path')
    model.add_argument('--tree_TD', type='bool', default=True,
                       help='maximum depth of root path')
    model.add_argument('--action_size', type=int, default=16,
                       help='maximum depth of root path')
    model.add_argument('--inner_TF', type='bool', default=False,
                       help='maximum depth of root path')
    model.add_argument('--local_relation', type='bool', default=False,
                       help='maximum depth of root path')
    model.add_argument('--sqrt', type=int, default=-1)
    model.add_argument("--only_local_relation", type='bool', default=False, \
                       help="use advance tree positional encodings")
    model.add_argument("--pre_norm", type='bool', default=False, \
                       help="use advance tree positional encodings")
    model.add_argument("--td_add", type='bool', default=False, \
                       help="use advance tree positional encodings")
    model.add_argument("--hard_relation", type='bool', default=False, \
                       help="use advance tree positional encodings")
    model.add_argument("--td_cat", type='bool', default=False, \
                       help="use advance tree positional encodings")
    model.add_argument("--post_norm", type='bool', default=False, \
                       help="use advance tree positional encodings")
    model.add_argument("--bi_linear", type='bool', default=False, \
                       help="use advance tree positional encodings")
    model.add_argument("--no_PN", type='bool', default=False, \
                       help="use advance tree positional encodings")

    model.add_argument("--only_1", type='bool', default=False, \
                       help="use advance tree positional encodings")
    model.add_argument("--only_2", type='bool', default=False, \
                       help="use advance tree positional encodings")
    ...
    seq2seq.add_argument('--share_decoder_encoder_embeddings', type='bool', default=False,
                         help='Share encoder embeddings weight with decoder: make sure src vocab is a joint src-tgt vocab!')
