...
class PositionwiseFeedForward(nn.Module):
    ...
    def __init__(self, d_model, d_ff, dropout=0.1, args=None):
    ...
    def forward(self, x):
        ...
        '''
            ...
            '''
        if self.post_norm:
            sublayer = self.output(self.dropout_1(self.relu(self.intermediate(x))))
            return self.layer_norm(self.dropout_2(sublayer) + x)
        else:
